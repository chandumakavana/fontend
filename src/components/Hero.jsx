          ...
          <div className='max-md:w-[90vw] overflow-hidden py-5'>
            ...
            <div className='flex gap-4 mt-5 max-md:flex-col max-md:items-center'>
              <Link 
                ...
                duration={500} 
                offset={-80}
                className='uppercase px-6 py-3 font-bold bg-white rounded-lg border hover:bg-yellow-300 hover:shadow-lg hover:-translate-y-0.5 transition-all ease-in-out cursor-pointer'
              >
                contact me
              </Link>
              ...
              <button 
                ...
                className='uppercase px-6 py-3 font-bold bg-yellow-400 text-gray-800 rounded-lg border hover:bg-yellow-500 hover:shadow-lg hover:-translate-y-0.5 transition-all ease-in-out'
              >
                download resume
              </button>
            </div>
